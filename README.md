...
```bash
# With uv (recommended):
uv add 'kraty-server-sdk @ git+https://github.com/PedroTrincheiras/kraty-sdk-server-python.git@v0.11.0'

# Or pip:
pip install 'git+https://github.com/PedroTrincheiras/kraty-sdk-server-python.git@v0.11.0'
```
